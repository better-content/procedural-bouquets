...
public class BouquetItemRenderer extends BlockEntityWithoutLevelRenderer {
    ...
    public void renderByItem(ItemStack stack, ItemDisplayContext displayContext, PoseStack poseStack, MultiBufferSource buffer, int packedLight, int packedOverlay) {
        ...
        renderWrap(poseStack, buffer, packedLight, packedOverlay);
    ...
    private static void renderWrap(PoseStack poseStack, MultiBufferSource buffer, int packedLight, int packedOverlay) {
